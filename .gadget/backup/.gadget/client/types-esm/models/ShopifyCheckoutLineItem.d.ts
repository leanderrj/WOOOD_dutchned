...
import { Query, PromiseOrLiveIterator, ShopifyCheckoutLineItem, AvailableShopifyCheckoutLineItemSelection, ShopifyCheckoutLineItemSort, ShopifyCheckoutLineItemFilter } from "../types.js";
 ...
 * ```
 */
export type ShopifyCheckoutLineItemRecord<Selection extends AvailableShopifyCheckoutLineItemSelection | undefined = typeof DefaultShopifyCheckoutLineItemSelection> = DeepFilterNever<GadgetRecord<SelectedShopifyCheckoutLineItemOrDefault<{
    select: Selection;
}>>>;
...
declare const modelApiIdentifier: "shopifyCheckoutLineItem";
declare const pluralModelApiIdentifier: "shopifyCheckoutLineItems";
...
/**
 * A manager for the shopifyCheckoutLineItem model with all the available operations for reading and writing to it.*/
export declare const ShopifyCheckoutLineItemManager: {
