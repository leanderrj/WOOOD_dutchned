...
export interface CreateShopifyCheckoutActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyCheckout?: { id?: string;abandonedCheckoutUrl?: string;appliedDiscount?: Scalars["JSON"];buyerAcceptsMarketing?: boolean;completedAt?: Date;shopifyCreatedAt?: Date;creditCard?: string;currency?: string;customerLocale?: string;device?: number;discountCode?: string;discountCodes?: Scalars["JSON"];email?: string;legalNoticeUrl?: string;name?: string;note?: string;noteAttributes?: Scalars["JSON"];orderStatusUrl?: string;paymentDue?: string;paymentUrl?: string;payments?: Scalars["JSON"];phone?: string;presentmentCurrency?: string;privacyPolicyUrl?: string;refundPolicyUrl?: string;requiresShipping?: boolean;reservationTime?: number;reservationTimeLeft?: number;shippingLine?: Scalars["JSON"];shippingPolicyUrl?: string;shopifyPaymentsAccountId?: string;sourceIdentifier?: string;sourceName?: string;sourceUrl?: string;subscriptionPolicyUrl?: string;subtotalPrice?: string;taxExempt?: boolean;taxLines?: Scalars["JSON"];taxManipulations?: Scalars["JSON"];taxesIncluded?: boolean;termsOfSaleUrl?: string;termsOfServiceUrl?: string;token?: string;totalLineItemsPrice?: string;totalPrice?: string;totalTax?: string;totalTipReceived?: string;shopifyUpdatedAt?: Date;userId?: string;webUrl?: string;shop?: { _link: string | null };order?: { _link: string | null }; };
};
  /**
