...
export interface CreateShopifyProductActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyProduct?: { id?: string;category?: Scalars["JSON"];compareAtPriceRange?: Scalars["JSON"];hasVariantsThatRequiresComponents?: boolean;productCategory?: Scalars["JSON"];body?: string;shopifyCreatedAt?: Date;handle?: string;productType?: string;publishedAt?: Date;status?: string;tags?: Scalars["JSON"];templateSuffix?: string;title?: string;shopifyUpdatedAt?: Date;vendor?: string;shop?: { _link: string | null };shippingMethod2?: string; };
};
  /**
