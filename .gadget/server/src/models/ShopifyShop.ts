...
export interface UpdateShopifyShopActionContext extends AmbientContext {
  ...
  */
  params: {
shopifyShop?: { id?: string;alerts?: Scalars["JSON"];billingAddress?: Scalars["JSON"];checkoutApiSupported?: Scalars["JSON"];countriesInShippingZones?: Scalars["JSON"];currencyFormats?: Scalars["JSON"];customerAccounts?: string;description?: string;orderNumberFormatPrefix?: string;orderNumberFormatSuffix?: string;resourceLimits?: Scalars["JSON"];richTextEdiorUrl?: string;shipsToCountries?: string[];customerAccountsV2?: Scalars["JSON"];plan?: Scalars["JSON"];timezoneAbbreviation?: string;taxesOffset?: string;timezoneOffsetMinutes?: number;unitSystem?: string;url?: string;address1?: string;address2?: string;city?: string;country?: string;countryCode?: string;countryName?: string;countyTaxes?: Scalars["JSON"];shopifyCreatedAt?: Date;currency?: string;customerEmail?: string;domain?: string;eligibleForPayments?: boolean;email?: string;enabledPresentmentCurrencies?: string[];finances?: boolean;googleAppsDomain?: string;googleAppsLoginEnabled?: boolean;hasDiscounts?: boolean;hasGiftCards?: boolean;hasStorefront?: boolean;ianaTimezone?: string;latitude?: number;longitude?: number;marketingSmsContentEnabledAtCheckout?: boolean;moneyFormat?: string;moneyInEmailsFormat?: string;moneyWithCurrencyFormat?: string;moneyWithCurrencyInEmailsFormat?: string;multiLocationEnabled?: boolean;myshopifyDomain?: string;name?: string;passwordEnabled?: boolean;phone?: string;planDisplayName?: string;planName?: string;preLaunchEnabled?: boolean;primaryLocale?: string;province?: string;provinceCode?: string;requiresExtraPaymentsAgreement?: boolean;setupRequired?: boolean;shopOwner?: string;source?: string;taxShipping?: boolean;taxesIncluded?: boolean;timezone?: string;transactionalSmsDisabled?: boolean;shopifyUpdatedAt?: Date;weightUnit?: string;zipCode?: string; };    
id?: string;
};
  /**
