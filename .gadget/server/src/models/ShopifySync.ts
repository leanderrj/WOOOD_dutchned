...
import { GadgetRecord, ShopifySync } from "@gadget-client/woood";
...
export interface AbortShopifySyncActionContext extends AmbientContext {
  ...
  */
  params: {
shopifySync?: { syncSince?: Date;domain?: string;errorDetails?: string;errorMessage?: string;force?: boolean;models?: Scalars["JSON"];shop?: { _link: string | null };syncSinceBy?: string; };    
id?: string;
};
  /**
