...
async function getDeliveryDates(logger) {
    ...
    if (useMockData) {
        ...
        const mockData = (0, mockDataGenerator_1.generateMockDeliveryDates)();
...
async function fetchDeliveryDatesWithRetry(logger) {
    ...
    for (let attempt = 1; attempt <= maxRetries; attempt++) {
        ...
        try {
            ...
            const deliveryDates = await (0, dutchNedClient_1.fetchDeliveryDatesFromAPI)(logger);
...
//# sourceMappingURL=deliveryDatesService.js.map