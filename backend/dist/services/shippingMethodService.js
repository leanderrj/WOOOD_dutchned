...
exports.processShippingMethodSelection = processShippingMethodSelection;
exports.getShippingMethodData = getShippingMethodData;
...
const shippingMethodStorage = new Map();
async function processShippingMethodSelection(data, logger, featureFlags = getDefaultFeatureFlags()) {
...
async function getShippingMethodData(identifier, logger) {
    try {
...
function validateShippingMethodData(data) {
    const errors = [];
...
async function processOrderMetafields(data, logger, requestId) {
    try {
...
//# sourceMappingURL=shippingMethodService.js.map